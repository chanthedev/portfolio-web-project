...
function Work(isDarkMode) {
  return (
    ...
    id='work' className='w-fuill px-[12%] py-10 scroll-mt-20'>
      ...
      <motion.p 
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
          Welcome to my web portfolio! Explore a collection of projects 
          showcasing my expertise in Cloud Engineering and Architecture.</motion.p>
